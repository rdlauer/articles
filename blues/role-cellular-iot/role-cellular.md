...
IoT developers today have a myriad of choices when deciding [which network connectivity option is best for them](/blog/network-connectivity/). When you add up all the pros and cons, many are surprised to find cellular as the logical path forward (if not for a primary connection, then as a fallback).
...
While 2G/3G protocols are perfectly adequate technologies for many IoT applications, modern IoT generally relies on LTE-M or NB-IoT. The rapid expansion of LTE-M and NB-IoT is setting the standard for a new dawn of IoT connectivity.
...
Cellular IoT technologies like LTE-M and NB-IoT introduce significant advantages for remote IoT deployments. Often considered a best choice for a wide range of applications, especially those in mobile or otherwise unpredictable locations, cellular is a mature, reliable, and logical choice.

Learn more about how Blues Wireless is making cellular IoT adoption easier for businesses AND developers with the [Notecard](https://blues.io/products/) (and read the next post in this series on [The Advantages of Cellular IoT](NEED LINK)).

--------------------------------------------------------------------------------

# The Advantages of Cellular IoT

IoT developers and the businesses that support them have a vested interest in using the best network connectivity option available (both from developer experience and expense angles). For many, WiFi has been an obvious choice due to high bandwidth requirements. While for others building stationary solutions with easy access to wired Ethernet, that connection method is equally a no-brainer.
...
- **Global:** There is no other network technology with the reach of cellular.
...
The advantages of cellular IoT are crystal clear. Unmatched global coverage, embedded device security, "it just works" installation, and exceedingly low power requirements make it an obvious choice for the IoT.

Learn more about how Blues Wireless is making cellular IoT adoption easier for businesses AND developers with the [Notecard](https://blues.io/products/) (and read the next post in this series on [Common Use Cases for Cellular IoT](NEED LINK)).
...
But what *are* some examples of those solutions? Who is using cellular IoT today? There are many valid (and obvious) use cases for cellular IoT, but at the same time there are scenarios where cellular isn't normally considered.
...
![IoT in greenhouse](3-agriculture-iot.jpg)

*Image credit [@thisisengineering](https://unsplash.com/@thisisengineering) on Unsplash.*

## The Notecard for All of the Above

The [Notecard from Blues Wireless](https://blues.io/products/) provides wireless connectivity for IoT projects of all types. It checks all the boxes we've referenced above, [and then some](https://blues.io/products/).
...
Learn more about how Blues Wireless is making cellular IoT adoption easier for businesses AND developers with the [Notecard](https://blues.io/products/) (and read the next post in this series on [Cellular IoT Network and Infrastructure Redundancy](NEED LINK)).

--------------------------------------------------------------------------------

# Cellular IoT Network and Infrastructure Redundancy

If you've been following along [in this blog series](NEED LINK), you've seen how cellular connectivity can be ideal for IoT solutions in logistics, manufacturing, security, asset tracking, among other industries. Cellular IoT devices can send and receive data from virtually anywhere in the world, utilizing an infrastructure that has been built up over decades.

It's a bit surreal in that you can deploy an IoT device virtually anywhere in the world and start sending and receiving data in seconds.

![data dashboard](4-dashboard.jpg)

*Image credit [@lukechesser](https://unsplash.com/@lukechesser) on Unsplash.*

Today we are going to tackle the topic of *redundancy* in relation to cellular IoT networking. How prepared are you for all possible deployment scenarios for the lifespan of your IoT device?
...
Regardless of the *why* of a failure, your end user is less likely to blame their WiFi router and more likely to blame you, the device provider, for not being able to account for all outage scenarios.
...
Cellular holds numerous security-related advantages:
...
Learn more about how Blues Wireless is making cellular IoT adoption easier for businesses AND developers with the [Notecard](https://blues.io/products/).
